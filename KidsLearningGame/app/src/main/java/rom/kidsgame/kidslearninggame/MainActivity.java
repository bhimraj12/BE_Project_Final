...
import rom.kidsgame.kidslearninggame.activity.SettingsActivity;
import rom.kidsgame.kidslearninggame.util.BackgroundSoundService;
import rom.kidsgame.kidslearninggame.util.MusicManager;
import rom.kidsgame.kidslearninggame.util.PrefClass;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView g1=(ImageView) findViewById(R.id.btn_alphabet_training);
        g1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextintent=new Intent(MainActivity.this, AlphabetTraining.class);
                startActivity(nextintent);
            }
        });

        ImageView g3=(ImageView) findViewById(R.id.btn_maths_quiz);
        g3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextintent=new Intent(MainActivity.this, maths_quiz.class);
                startActivity(nextintent);
            }
        });

        ImageView g5=(ImageView) findViewById(R.id.btn_draw);
