...
import rom.kidsgame.kidslearninggame.util.PrefUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String shareBody = "Share this Learning Kids Game for great future. " + "https://play.google.com/store/apps/details?id=rom.kidsgame.kidslearninggame";
